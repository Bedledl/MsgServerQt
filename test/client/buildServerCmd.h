...
{
public:
    TestServerCommunicator(int chatKey, int participantKey, std::string participantName, std::string testMessageContent, QDateTime timestamp, std::vector<unsigned> participantKeys);
...
private:
    ...
    QDateTime timestamp;
    std::vector<unsigned> participantKeys;
};
