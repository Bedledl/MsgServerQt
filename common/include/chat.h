...
public:
     ...
     */
    void addParticipant(std::shared_ptr<Participant> sender);
    /**
     * @brief Removes a participant from the chat.
     *
     * @param sender The participant to be removed.
     */
    void removeParticipant(std::shared_ptr<Participant> sender);
    /**
...
protected:
    ...
    QList<std::shared_ptr<Participant>> participants = QList<std::shared_ptr<Participant>>();
