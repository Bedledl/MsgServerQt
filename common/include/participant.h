...
public:
     ...
     */
    explicit Participant(const ParticipantKey key,
                         QString name = "Unknown",
                         QDateTime registeredSince = QDateTime::currentDateTime()) : key(key), name(std::move(name)), registeredSince(std::move(registeredSince)){};
